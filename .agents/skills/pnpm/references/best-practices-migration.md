...
{
  "scripts": {
    // Run a script recursively with pnpm.
    "build:all": "pnpm -r run build",

    // Target a workspace with pnpm.
...
This project is already migrated. Preserve its pnpm lockfile and configuration; do not fall back to another package manager.
