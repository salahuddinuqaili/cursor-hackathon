...
React Router owns Vite in this project. Use the project build script and do not start a Vite development or preview server.

```bash
pnpm run build
pnpm exec vite --version  # Narrow Vite-specific inspection only.
```
