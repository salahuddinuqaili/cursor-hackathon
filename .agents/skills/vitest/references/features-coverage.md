...
Run with `pnpm exec vitest --ui` to view coverage visually.
...
```bash
pnpm exec vitest run --shard=1/3 --coverage --reporter=blob
pnpm exec vitest run --shard=2/3 --coverage --reporter=blob
pnpm exec vitest run --shard=3/3 --coverage --reporter=blob

pnpm exec vitest --merge-reports --coverage --reporter=json
```
